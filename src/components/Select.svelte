<script lang="ts">
  ...
  import { minmax } from '@helpers/statistics';
  ...
  function handleClick() {
    ...
    if ( pos > -1 ) {
      list.children[0].children[pos * 2].scrollIntoView({ block: 'center', behavior: 'instant' });
    }
  }
</script>
...
<Dropdown { placement } bind:open={ showOptions } id={ selectID }
  class="max-h-[20rem] overflow-y-scroll z-50" containerClass="overflow-hidden">
