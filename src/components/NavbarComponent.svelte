    ...
    <NavUl {hidden} class="order-1">
      <Link on:click={() => checkMobile(toggle)} to="/contests">
        <NavLi class="flex items-center gap-1">
          <SwordIcon class="dark:text-red-400 text-red-600" /> Competencias
        </NavLi>
      </Link>
      ...
      <Link on:click={() => checkMobile(toggle)} to="/rules">
        <NavLi class="flex items-center gap-1">
          <RulesIcon class="dark:text-orange-300 text-orange-400" /> Reglamento
        </NavLi>
      </Link>
      <Link on:click={() => checkMobile(toggle)} to="/cca">
        <NavLi class="flex items-center gap-1">
          <CubeIcon class="dark:text-primary-400 text-primary-500" /> CCA
        </NavLi>
      </Link>
