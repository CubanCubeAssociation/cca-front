...
export function MEGAMINX(): PuzzleInterface {
  ...
  type FaceName = "U" | "R" | "F" | "L" | "BL" | "BR" | "DR" | "DL" | "DBL" | "B" | "DBR" | "D";
...
//   faceVectors.push(center.stickers[0].getOrientation());

//   for (let i = 0, maxi = midCenters.length; i < maxi; i += 1) {
//     faceVectors.push(midCenters[i].stickers[0].getOrientation());
//   }

//   faceVectors.push(center.stickers[0].getOrientation().rotate(CENTER, RIGHT, PI));
...
//   mega.pieces = pieces;
//   mega.faceVectors = faceVectors;
//   mega.raw = [anchors, FACE_ANG, FACTOR, RAD, SIDE];

//   assignColors(mega, faceColors);
